...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // Деталі
        Collection<Part> listOfCharacteristicsOfBoxes = List.of(
                new Cube(450, 0.1),
                new Cube(300, 0.2),
                new Sphere( 150, 0.3),
        ...
        // Коробки
        Collection<Box> listOfSizesOfBoxes = List.of(
                new Box(700),
                new Box(500),
                new Box(500),
                new Box(500),
        ...
        new PartsProcessor().packageParts(listOfCharacteristicsOfBoxes, listOfSizesOfBoxes, boxPackagingPricePerMeter); // Підказка: в цьому виклиці складно розібратися з сігнатурою через погані імена зммінних.(Змінив)
    }
}
